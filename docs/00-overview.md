...
| 主題 | 決定 | 詳見 |
|---|---|---|
| 位置單位 | **以地區為單位**：台灣＝縣市、印度＝縣（district）、馬來西亞＝縣（daerah）。市場是地區底下的細節 | [02](02-product-spec.md) |
...
| 示範國家 | 印度（英文、印地文、盧比）、台灣（繁中、新台幣）與馬來西亞（英文、令吉；2026-09-20 追加，使用者同意） | [06](06-data.md) |
...
| 零售價 | 地區的零售調查價。以地區為單位，沒有市場細項；馬來西亞是地區內各濕巴剎報價的中位數 |
